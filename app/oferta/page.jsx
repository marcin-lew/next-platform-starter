...
const Oferta = () => {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-center mb-8 text-white">Jak zrozumieliśmy twoją sytuację?</h1>
      ...
      <h2 className="text-3xl font-bold text-center mb-6 text-white">Współpraca z dostawcami</h2>
